...
# Eliminar xmlrpc.php
RUN rm -f /var/www/html/xmlrpc.php

# Crear un archivo .htaccess para deshabilitar xmlrpc.php para todas las IPs excepto las permitidas
RUN echo "<FilesMatch \"xmlrpc\\.php$\">" >> /var/www/html/.htaccess && \
    ...
    echo "  Allow from 1.2.3.4" >> /var/www/html/.htaccess && \
